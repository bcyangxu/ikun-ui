(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2["xu-ui"] = {}));
...
Component that was made reactive: `, type);
  ...
  const _sfc_main = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
      ...
      defineOptions({ name: "xu-button" });
      const buttonStyle = computed(() => {
        return {
          [`xu-button--${ButtonProps.type}`]: ButtonProps.type
        };
      });
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("button", {
          class: normalizeClass(["xu-button", unref(buttonStyle)])
        }, [
